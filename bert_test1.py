'''
提示：受GPU性能的影响，只能运行基础版的bert预训练模型，若出现OOM 适当调整batch_size,maxlen
我用的是numpy==1.16.4。其他版本可能会有提示
'''
...
def get_train_test_data():
    train_df = pd.read_excel(r'C:\Users\独为我唱\Desktop\bert文本分类测试\data_train.xlsx').astype(str)
    test_df = pd.read_excel(r'C:\Users\独为我唱\Desktop\bert文本分类测试\data_test.xlsx').astype(str)
...
dict_path = r'C:\Users\独为我唱\Desktop\bert文本分类测试\bert\vocab.txt'     #词表
